...
public interface BillRepository extends JpaRepository<Bill, Long> {
    ...
    @Query("SELECT b FROM Bill b WHERE b.member = :member AND b.paidStatus <> :paidStatus ORDER BY " +
            "CASE WHEN b.paidStatus = 'UNPAID' THEN 0 ELSE 1 END , b.deadline ASC")
    ...
    @Query(value = "SELECT b FROM Bill b WHERE b.paidStatus = 'UNPAID' AND b.isObjection= 'N' AND TO_CHAR(b.deadline, 'YYYYMMDD') = :formattedDate")
    List<Bill> findUnpaidBillsDueInTwoDays(String formattedDate);
}

...
//        String refreshToken = tokenProvider.generatePoliceToken(police, Duration.ofSeconds(50));
...
//        String accessToken = tokenProvider.generatePoliceToken(police, Duration.ofSeconds(15));
